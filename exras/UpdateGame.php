...
if(isset($_GET['id'])){
    ...
    $SQL="SELECT  Name ,Type , Description , Picture , StoryVideo FROM game WHERE GameID='".$_GET['id']."' ;";
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                                            <form  enctype="multipart/form-data" id="contact" action="AdminFunctions.php" method="POST"> <!-- onsubmit="Validate(this);" -->
