								...
								<div id="box" class="row">
									<div class="fill-form">
										<div class="col-lg-12" style="margin: auto;">
											<fieldset>
												<div class="formTxt3"><label id="Form1" for="name" style="background-color: white; left: 1vw;">Please fill the information</label></div>
												<br>
                                                                                                <p id='Success'></p>
                                                                                                <br>
                                                                                                <div class="formTxt1"></div>
												<input id="uname" type="nameu" name="nameu"  placeholder="Enter your name" autocomplete="on" pattern="[A-Za-z]{3,}$" title="At least 3 letters only" required>
											<br>
												<div class="formTxt1"></div>
